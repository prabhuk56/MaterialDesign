package com.example.prabhu.activity;
...
import com.example.prabhu.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    private OnFragmentInteractionListener drawerListener;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.print("titles length:"+titles.length);
    }

    private List<NavDrawer> getData() {
        List<NavDrawer> navDataList=new ArrayList<>();
        for(int i=0;i<titles.length;i++){
            NavDrawer navItem= new NavDrawer();
            navItem.setTitle(titles[i]);
            navDataList.add(navItem);
        }
        return navDataList;
    }
    @Override
